...
- Inteligência artificial, partidas online, relógio e interface gráfica.

## Débitos técnicos conhecidos

- A enumeração de jogadas legais é força bruta, adequada ao CLI atual.
- Não há importação/exportação FEN ou PGN.
